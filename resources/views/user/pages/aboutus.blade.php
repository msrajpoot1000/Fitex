...
@section('title', 'Fitex Uniforms | About Us')
...
@section('write')
                ...
                <div class="row align-items-center cs_gap_y_40">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-duration="0.9s" data-wow-delay="0.25s">
                        <div class="cs_about_thumb">
                            <img src="assets/img/about_img_23.jpg" alt="About" style="border-radius: 10px">
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="cs_about_content">
                            <div class="cs_section_heading cs_style_1 cs_mb_22">
                                ...
                                {{-- <h2 class="cs_section_title cs_fs_48 cs_semibold mb-0">Turning up the chill factor in your
                                    home or office</h2> --}}
                            </div>
                            ...
                            <div class="cs_about_btns">
                                ...
                                <div class="cs_about_avatar">
                                    <div class="cs_about_avatar_thumb">
                                        <img src="assets/img/avatar_11.png" alt="">
                                    </div>
                                    <div class="cs_about_phone_number_right">
                                        <h3 class="cs_fs_20 cs_medium cs_mb_5">Your Name</h3>
                            ...
                            <div class="cs_slider_wrapper">
                                <div class="cs_slide">
                                    <div class="cs_testimonial cs_style_1">
                                        ...
                                        <blockquote class="cs_testimonial_blockquote cs_white_color cs_mb_25 cs_fs_16">Air
                                            conditioning services encompass a range of maintenance, repair, installation,
                                            and consultation activities designed to ensure the efficient operation and
                                            longevity of air conditioning systems</blockquote>
    ...
    {{-- <section class="cs_bg_filed" data-src="assets/img/how_to_work_bg.svg">
        ...
        <div class="container">
            <div class="cs_section_heading_1_with_sub">
                ...
                <p class="mb-0">Keeping the outdoor unit clean, and sealing any you leaks in your home can improve
                    efficiency</p>
            </div>
            <div class="cs_height_45 cs_height_lg_45"></div>
                ...
                <div class="cs_card_1_col">
                    <div class="cs_card cs_style_1">
                        <div class="cs_card_in cs_white_bg">
                            ...
                            <p class="cs_fs_14 cs_mb_25">Upgrade to the latest energy and efficient air conditioning Frost
                                technology with Eco Cool</p>
                ...
                <div class="cs_card_1_col">
                    <div class="cs_card cs_style_1 cs_type_1">
                        <div class="cs_card_in cs_white_bg">
                            ...
                            <p class="cs_fs_14 cs_mb_25">The Arctic Blast Repair service addresses all your air Eco Cool
                                conditioning repair needs</p>
                            <a href="about-us.html"
                                class="cs_text_btn cs_fs_14 text-uppercase cs_heading_color cs_bold cs_mb_30">
                                READ MORE
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="cs_card_1_col">
                    <div class="cs_card cs_style_1">
                        <div class="cs_card_in cs_white_bg">
                            ...
                            <p class="cs_fs_14 cs_mb_25">Our Quick Cool Installation and service provides fast and cooling
                                efficient installation </p>
                            <a href="about-us.html" class="cs_text_btn cs_fs_14 text-uppercase cs_heading_color cs_bold">
                                READ MORE
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="cs_card_1_col">
                    <div class="cs_card cs_style_1 cs_type_1">
                        <div class="cs_card_in cs_white_bg">
                            ...
                            <p class="cs_fs_14 cs_mb_25">We handle everything from and assessing your cooling needs to
                                positioning Arctic Blast</p>
                            <a href="about-us.html"
                                class="cs_text_btn cs_fs_14 text-uppercase cs_heading_color cs_bold cs_mb_30">
                                READ MORE
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
    ...
    <!-- Start How To What We Do Section -->
    <section class="cs_bg_filed" data-src="assets/img/how_to_work_bg.svg">
        <div class="cs_height_115 cs_height_lg_70"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="cs_height_45 cs_height_lg_45"></div>
                    <p>
                        At Fitex, we specialize in custom-made uniforms tailored to your brands identity and operational
                        needs.
                        Whether it's a consistent supply of ready-made styles or fully customized designs, we ensure every
                        piece
                        reflects professionalism, comfort, and durability.
                    </p>
                    <p>
                        Our in-house embroidery and printing services allow for fast, cost-effective branding helping
                        businesses
                        stand out while maintaining a unified team look.
                    </p>
                </div>
                <div class="col-lg-6">
                    <div class="cs_section_heading_1_with_sub">
                        <div class="cs_section_heading cs_style_1" style="width: 100%;text-align:right">
                            <h3 class="cs_section_subtitle cs_accent_color text-uppercase cs_medium cs_fs_20 cs_mb_10"
                                style="width:100%:text-align:right">
                                <img src="assets/img/icons/fan.svg" alt="" class="cs_section_subheading_icon">
                                Why Fitex?
                            </h3>
                            <h2 class="cs_section_title cs_fs_48 cs_semibold mb-0">What Sets Fitex Apart</h2>
                        </div>
                        {{-- <p class="mb-0">Keeping the outdoor unit clean, and sealing any you leaks in your home can improve
                    efficiency</p> --}}
                    </div>
                    <div class="cs_height_45 cs_height_lg_45"></div>
                    <p>
                        Bulk Manufacturing Expertise: Large orders? No problem. Were structured to deliver on time and on
                        scale.
                        Customization at Scale: From fabric selection to logo placement, we offer end-to-end customization
                        with a
                        low turnaround cost.
                    <p>
                    </p>
                    Recurring Order Support: For companies needing regular supply, we maintain stock of your specific styles
                    to
                    streamline repeat ordering.
                    Industry Versatility: One supplier for all: Whether you're in healthcare or hospitality, weve got a
                    uniform for
                    you.
                    </p>
                </div>
        ...
        <div class="cs_about cs_style_1">
            <div class="container pt-10">
                <div class="row align-items-center cs_gap_y_40">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-duration="0.9s" data-wow-delay="0.25s">
                        <div class="cs_about_thumb">
                            <img src="assets/img/mission.jpg" alt="About" style="border-radius: 10px">
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="cs_about_content">
                            ...
                            <p class="cs_mb_30">Our mission is to empower teams through exceptional uniforms combining
                                function, form, and identity in
                                every stitch. We believe that great uniforms boost confidence, enhance productivity, and
                                create lasting
                                impressions.</p>
                            <p>
                                Talk to our agent directly: +1 (647) 867-3159

                            </p>
                            <p>
                                Based in Canada, serving businesses nationwide and beyond.
                            </p>
